...
public class ZenStudioXPathSelectors
{
    ...
    public const string GoToChannelButton =
        "//h2[@class='Text Text_weight_bold Text_color_full Text_typography_headline-20-24 header__title-1o']";
