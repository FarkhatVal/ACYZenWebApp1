...
public class LoginPage : Page
{
    ...
    public static async Task<bool> Auth(IWebDriver driver, WebDriverWait wait, int i, string Login, string Password,
        string idNum, string? NewPassword, int? a1)
    {
        ...
        else
        {
                    ...
                    .Count > 0)
            {
                ...
                //Получаем новый СМС
                Thread.Sleep(30000);
                string codeNew1 = await GetSmsCodee.GetSmsCode(UiBase.Host, UiBase.ApiKey, idNum);
                //ВВодим СМС код
                var inputNewSms1 = driver.FindElement(By.XPath("//input[@data-t='field:input-phoneCode']"));
                inputNewSms1.SendKeys(codeNew1);
                var codeConfirm = driver.FindElement(By.XPath("//button[@data-t='button:action']"));
